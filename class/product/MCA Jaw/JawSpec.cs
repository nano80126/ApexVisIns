...
namespace MCAJawIns.Product
{
    ...
    public class JawSpecSettingProductor
    {
        ...
        public JawSpecSetting[] CreateMCAJawM()
        {
            ...
            center = new double[] { 0.1195, 0.1195, double.NaN, 0.014, 0.014, 0.014, 0.014, double.NaN, double.NaN, 0.194, double.NaN, double.NaN, 0, 0, 0, 0 };
        ...
        {
            items = new string[] { "0.174-R", "0.174-L", "0.364", "0.013-R", "0.013-L", "0.012-R", "0.012-L", "0.042-R", "0.042-L", "後開", "前開", "開度差", "輪廓度", "輪廓度R", "輪廓度L", "平直度" };
            center = new double[] { 0.1740, 0.1740, 0.346, 0.013, 0.013, 0.012, 0.012, 0.0420, 0.0420, 0.2775, double.NaN, double.NaN, 0, 0, 0, 0 };
            lowerc = new double[] { 0.1700, 0.1700, 0.342, 0.011, 0.011, 0.011, 0.011, 0.0405, 0.0405, 0.2670, double.NaN, 0.0200, 0, 0, 0, 0 };
            upperc = new double[] { 0.1780, 0.1780, 0.350, 0.015, 0.015, 0.013, 0.013, 0.0435, 0.0435, 0.2880, double.NaN, 0.0325, 0.008, 0.005, 0.005, 0.007 };
